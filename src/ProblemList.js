...
const columns = [
    {
        ...
        dataIndex: 'id',
        key: 'id',
        render: (text,record) => <App name={text} link={"./Problem?p"+record.id.replace(/[^0-9]/ig,"")}></App>,
        width:"10%",
    },
    {
        title: 'problem',
        dataIndex: 'pro_name',
        key: 'pro_name',
        render: (text,record) => <App name={text} link={"./Problem?p"+record.id.replace(/[^0-9]/ig,"")}>{text}</App>,
